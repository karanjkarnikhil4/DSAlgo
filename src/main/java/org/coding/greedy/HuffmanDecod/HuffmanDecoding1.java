package org.coding.greedy.HuffmanDecod;
...
class Decode
{
  static String decodeHuffmanData(MinHeapNode root, String binaryString)
  {
    ...
    {
      mainRoot =root;
      DecodedCharacterLength decodedCharacterLength =decodeStringCharacter(mainRoot,binaryString,index);
  ...
  static DecodedCharacterLength decodeStringCharacter(MinHeapNode root, String encodedStr, int index) {
    if (root == null) {
      return null;
    }
