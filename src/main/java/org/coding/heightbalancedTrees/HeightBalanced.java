package org.coding.heightbalancedTrees;
...
class GfG {
  ...
  public static void main(String[] args) throws IOException {
    ...
    while (t > 0) {
      ...
      if (g.isBalanced(root) == true) System.out.println(1);
...
class Tree {
  ...
  boolean isBalanced(Node root, Height height) {
    ...
    boolean isLeftBalanced = isBalanced(root.left,height);
    int leftHeight = height.height;
    height.height =0;
    boolean isRightBalanced = isBalanced(root.right, height);
