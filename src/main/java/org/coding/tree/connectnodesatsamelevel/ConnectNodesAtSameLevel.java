package org.coding.tree.connectnodesatsamelevel;
// { Driver Code Starts
...
class GfG {
  ...
  public static void printSpecial(Node root) {
    ...
    while (root != null) {
      ...
      if (root.left != null && next_root == null) next_root = root.left;
      else if (root.right != null && next_root == null) next_root = root.right;
    ...
    while (!queue1.isEmpty() || !queue2.isEmpty()) {
      ...
      while (!queue1.isEmpty()) {
        ...
        if (previousNode == null) previousNode = currentNode;
          ...
          previousNode.nextRight = currentNode;
        }
      ...
      while (!queue2.isEmpty()) {
        Node currentNode = queue2.remove();
        if (previousNode == null) previousNode = currentNode;
        else {
